...
<section style="max-width: 56rem; margin: 4rem auto; padding: 0 1rem;">
  <h3 style="text-align: center; font-size: 1.25rem; font-weight: 500; color: #1f2937; margin-bottom: 2.5rem;">
    Diagram 1 — Sovereign Sustainability Institutional Framework
  </h3>

  <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">
    
    <div style="width: 60%; border: 1px solid #d1d5db; background: white; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 6: Cross-Border Interoperability
    </div>

    <div style="width: 66.667%; border: 1px solid #d1d5db; background: white; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 5: Digital Reporting Infrastructure
    </div>

    <div style="width: 75%; border: 1px solid #d1d5db; background: white; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 4: Supervisory & Assurance Framework
    </div>

    <div style="width: 80%; border: 1px solid #d1d5db; background: white; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 3: Legal & Regulatory Embedding
    </div>

    <div style="width: 83.333%; border: 1px solid #d1d5db; background: white; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 2: National Disclosure Standards
    </div>

    <div style="width: 91.667%; border: 1px solid #d1d5db; background: white; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 1: National Policy Mandate
    </div>

    <div style="width: 100%; border: 1px solid #9ca3af; background: #f3f4f6; padding: 1rem 0; text-align: center; font-size: 0.875rem; font-weight: 500;">
