...
The Canonical ESG Reference Model (CERM) provides a vendor-neutral, interoperable reference architecture for sustainability reporting. This document establishes the foundational principles governing CERM's design, evolution, and application.
