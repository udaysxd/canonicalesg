...
<section style="max-width: 56rem; margin: 5rem auto; padding: 0 1.5rem;">
  <h3 style="text-align: center; font-size: 1.25rem; font-weight: 500; color: #1f2937; margin-bottom: 3rem;">
    Diagram 1 — Sovereign Sustainability Institutional Framework
  </h3>

  <div style="display: flex; flex-direction: column; align-items: center; gap: 0.75rem;">

    <div style="width: 60%; border: 1px solid #d1d5db; background-color: #f9fafb; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 6: Cross-Border Interoperability
    </div>

    <div style="width: 65%; border: 1px solid #d1d5db; background-color: #f9fafb; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 5: Digital Reporting Infrastructure
    </div>

    <div style="width: 70%; border: 1px solid #d1d5db; background-color: #f9fafb; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 4: Supervisory & Assurance Framework
    </div>

    <div style="width: 75%; border: 1px solid #d1d5db; background-color: #f9fafb; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 3: Legal & Regulatory Embedding
    </div>

    <div style="width: 80%; border: 1px solid #d1d5db; background-color: #f9fafb; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 2: National Disclosure Standards
    </div>

    <div style="width: 85%; border: 1px solid #d1d5db; background-color: #f9fafb; padding: 1rem 0; text-align: center; font-size: 0.875rem;">
      Layer 1: National Policy Mandate
    </div>

    <div style="width: 90%; border: 1px solid #9ca3af; background-color: #e5e7eb; padding: 1rem 0; text-align: center; font-size: 0.875rem; font-weight: 500;">
