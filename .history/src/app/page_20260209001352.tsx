    ...
    <main className="max-w-3xl mx-auto px-6 py-16">
      <div>
        ...
        <div className="mt-16">
          ...
          <p className="text-[#1a1a1a] mb-4">Sustainability reporting has become increasingly complex.</p>
          
          <p className="text-[#1a1a1a] mb-4">Organisations are asked to report similar information across multiple frameworks, jurisdictions, and stakeholder expectations — often using different terminology, structures, and assumptions.</p>
          
          <p className="text-[#1a1a1a] mb-4">This complexity has led to:</p>
          ...
          <p className="text-[#1a1a1a] mb-6">Canonical ESG exists to address this structural problem.</p>

          <h3 className="text-[1.25rem] font-semibold text-[#1a1a1a] mb-4 mt-8">The underlying issue</h3>
          
          <p className="text-[#1a1a1a] mb-4">Most sustainability frameworks are designed to answer <em>what</em> should be disclosed.</p>
          
          <p className="text-[#1a1a1a] mb-4">They are not designed to:</p>
          <ul className="list-disc list-inside text-[#1a1a1a] mb-6 space-y-1.5">
          ...
          <p className="text-[#1a1a1a] mb-6">As a result, interpretation happens repeatedly, informally, and inconsistently — often inside spreadsheets, consulting decks, or proprietary software systems.</p>

          <h3 className="text-[1.25rem] font-semibold text-[#1a1a1a] mb-4 mt-8">A structural, not normative, response</h3>
          
          <p className="text-[#1a1a1a] mb-4">Canonical ESG does not introduce new reporting requirements.</p>
          
          <p className="text-[#1a1a1a] mb-4">Instead, it provides a neutral reference architecture that:</p>
          <ul className="list-disc list-inside text-[#1a1a1a] mb-6 space-y-1.5">
          ...
          <p className="text-[#1a1a1a] mb-6">This separation allows existing standards to coexist while reducing duplication and ambiguity.</p>

          <h3 className="text-[1.25rem] font-semibold text-[#1a1a1a] mb-4 mt-8">Designed to coexist with standards</h3>
          
          <p className="text-[#1a1a1a] mb-4">Canonical ESG does not replace sustainability reporting frameworks.</p>
          
          <p className="text-[#1a1a1a] mb-4">Framework texts remain authoritative.</p>
          
          <p className="text-[#1a1a1a] mb-4">Canonical ESG is designed to:</p>
          <ul className="list-disc list-inside text-[#1a1a1a] mb-6 space-y-1.5">
            <li>work alongside ESRS, GRI, CDP, ISSB, and others,</li>
            <li>preserve professional judgement,</li>
            <li>support assurance and review,</li>
            <li>enable software systems without embedding hidden assumptions.</li>
          </ul>

          <h3 className="text-[1.25rem] font-semibold text-[#1a1a1a] mb-4 mt-8">Why now</h3>
          
          <p className="text-[#1a1a1a] mb-4">The need for interoperability, auditability, and automation in sustainability reporting is increasing.</p>
          
          <p className="text-[#1a1a1a] mb-4">As reporting requirements expand across regions and stakeholders, organisations require a more systematic way to:</p>
          <ul className="list-disc list-inside text-[#1a1a1a] mb-6 space-y-1.5">
          ...
          <p className="text-[#1a1a1a] mb-6">Canonical ESG exists to provide that shared foundation.</p>

          <h3 className="text-[1.25rem] font-semibold text-[#1a1a1a] mb-4 mt-8">What Canonical ESG aims to enable</h3>
          
          <p className="text-[#1a1a1a] mb-4">Canonical ESG aims to enable:</p>
          <ul className="list-disc list-inside text-[#1a1a1a] mb-6 space-y-1.5">
            <li>clearer disclosure traceability,</li>
            <li>reduced interpretation risk,</li>
            <li>improved consistency across reports,</li>
            <li>collaboration between practitioners, auditors, and tool builders.</li>
          </ul>
          
          <p className="text-[#1a1a1a] mb-6">It does not seek to centralise authority or define compliance.</p>

          <h3 className="text-[1.25rem] font-semibold text-[#1a1a1a] mb-4 mt-8">A shared reference, not a single truth</h3>
          
          <p className="text-[#1a1a1a] mb-4">Canonical ESG is intentionally non-authoritative.</p>
          
          <p className="text-[#1a1a1a] mb-4">Its value lies in making structure, meaning, and interpretation explicit — not in declaring what is correct.</p>
