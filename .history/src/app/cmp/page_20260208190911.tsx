  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-12">
      <div>
        ...
        <p className="text-[#1a1a1a] mb-4">
          <Link href="/cmp/registry/cmp-index.json" className="text-[#1a1a1a] underline underline-offset-[0.15em] decoration-[#999] hover:decoration-[#1a1a1a]">→ Download CMP Registry Index (cmp-index.json)</Link>
        </p>
