...
export default async function WhitepaperPage() {
  ...
  const authorBlock = `
    <section class="mb-12 border-b border-[#e5e5e5] pb-8">
      <div class="flex items-start gap-5">
        ...
        />
        <div>
          <p class="text-[#111] font-semibold text-[1.25rem]">
            Uday Singh
          </p>
          <p class="text-[#444] text-[1rem] mb-2">
            Founding Architect, Canonical ESG
          </p>
          <p class="text-[#555] text-[0.875rem] leading-relaxed max-w-[640px]">
