            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#555] text-[0.75rem] leading-snug max-w-[560px]">
                  Uday Singh leads Canonical ESG, an independent technical initiative focused on semantic infrastructure for sustainability disclosure. His work centres on ESG data architecture, cross-framework alignment, and structured implementation models that enhance regulatory coherence and interoperability.
                </p>
              </div>
            </div>
          </section>
