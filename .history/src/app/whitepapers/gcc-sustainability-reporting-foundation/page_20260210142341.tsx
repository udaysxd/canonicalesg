    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        <div>
          ...
          <section className="mb-8 border-b border-[#e5e5e5] pb-6 not-prose">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#444] text-[0.75rem] mb-1">
                  Founding Architect, Canonical ESG
                </p>
                <p className="text-[#555] text-[0.75rem] leading-snug max-w-[560px]">
