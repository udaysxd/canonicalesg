...
export const metadata: Metadata = {
  title: "Stabilising ISSB Implementation: The Case for Institutional Infrastructure - Canonical ESG",
  description: "A technical analysis of ISSB implementation challenges and the need for institutional infrastructure to stabilise sustainability reporting systems beneath IFRS S1 and S2.",
  keywords: ["ISSB", "IFRS S1", "IFRS S2", "sustainability reporting", "ESG infrastructure", "implementation architecture", "Canonical ESG", "stabilising ISSB", "disclosure standards"],
  authors: [{ name: "Uday Singh" }],
  openGraph: {
    title: "Stabilising ISSB Implementation: The Case for Institutional Infrastructure",
  ...
  twitter: {
    ...
    title: "Stabilising ISSB Implementation: The Case for Institutional Infrastructure",
    description: "A technical analysis of ISSB implementation challenges",
  },
  alternates: {
    canonical: "https://canonicalesg.org/whitepapers/issb-implementation-infrastructure",
  },
};

export default async function WhitepaperPage() {
  const [html, rawText, headings] = await Promise.all([
    renderMarkdown('content/whitepapers/issb-implementation-infrastructure/index.md'),
    getRawText('content/whitepapers/issb-implementation-infrastructure/index.md'),
    getHeadings('content/whitepapers/issb-implementation-infrastructure/index.md')
  ]);

  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Stabilising ISSB Implementation: The Case for Institutional Infrastructure',
    description: 'A technical analysis of ISSB implementation challenges and the need for institutional infrastructure',
    url: 'https://canonicalesg.org/whitepapers/issb-implementation-infrastructure',
    author: {
      '@type': 'Person',
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': 'https://canonicalesg.org/whitepapers/issb-implementation-infrastructure',
    },
  };
