...
export const metadata: Metadata = {
  title: "From Standard to System: Strengthening the Infrastructure of ISSB Implementation - Canonical ESG",
  description: "A technical analysis of ISSB implementation challenges and the need for institutional infrastructure to stabilise sustainability reporting systems beneath global disclosure standards.",
  keywords: ["ISSB", "IFRS S1", "IFRS S2", "sustainability reporting", "ESG infrastructure", "implementation architecture", "Canonical ESG", "standard to system", "disclosure standards"],
  authors: [{ name: "Uday Singh" }],
  openGraph: {
    title: "From Standard to System: Strengthening the Infrastructure of ISSB Implementation",
...
export default async function WhitepaperPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'Article',
    headline: 'From Standard to System: Strengthening the Infrastructure of ISSB Implementation',
    description: 'A technical analysis of ISSB implementation challenges and the need for institutional infrastructure',
    url: 'https://canonicalesg.org/whitepapers/issb-implementation-infrastructure',
    author: {
      '@type': 'Person',
