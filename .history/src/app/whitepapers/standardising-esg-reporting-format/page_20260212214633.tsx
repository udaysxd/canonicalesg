...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://canonicalesg.org/whitepapers/standardising-esg-reporting-format",
  },
};

export default async function WhitepaperPage() {
  const [html, rawText, headings] = await Promise.all([
    renderMarkdown('content/whitepapers/standardising-esg-reporting-format/index.md'),
    getRawText('content/whitepapers/standardising-esg-reporting-format/index.md'),
    getHeadings('content/whitepapers/standardising-esg-reporting-format/index.md')
  ]);
  ...
  const jsonLd = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': 'https://canonicalesg.org/whitepapers/standardising-esg-reporting-format',
    },
  };
