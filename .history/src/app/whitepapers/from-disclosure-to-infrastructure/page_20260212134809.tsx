...
export const metadata: Metadata = {
  title: "From Disclosure to Infrastructure: A Structural Reform Blueprint for Global ESG Reporting - Canonical ESG",
  ...
  openGraph: {
    title: "From Disclosure to Infrastructure: A Structural Reform Blueprint for Global ESG Reporting",
...
export default async function WhitepaperPage() {
  ...
  const jsonLd = {
    ...
    '@type': 'Article',
    headline: 'From Disclosure to Infrastructure: A Structural Reform Blueprint for Global ESG Reporting',
    description: 'A structural reform proposal for global ESG reporting infrastructure',
    url: 'https://canonicalesg.org/whitepapers/from-disclosure-to-infrastructure',
    author: {
      '@type': 'Person',
