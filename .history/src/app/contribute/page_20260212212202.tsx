...
export const frameworkCoverageMetadata: Metadata = {
...
export const licensingMetadata: Metadata = {
  title: "Licensing - Canonical ESG",
  description: "Licensing information for Canonical ESG's open semantic infrastructure initiative.",
  alternates: {
