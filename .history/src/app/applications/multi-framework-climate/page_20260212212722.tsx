...
export const metadata: Metadata = {
  title: "Multi-Framework Climate Reporting - Canonical ESG",
  description: "Multi-framework climate reporting without semantic drift — ESRS, ISSB, GRI, and CDP alignment using Canonical ESG.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/multi-framework-climate",
  },
}

export const regulatoryModellingMetadata: Metadata = {
  title: "Regulatory & Double Materiality Modelling - Canonical ESG",
  description: "How Canonical ESG models regulatory interpretation and double materiality without embedding legal logic into the canonical semantic layer.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/regulatory-modelling",
  },
}
