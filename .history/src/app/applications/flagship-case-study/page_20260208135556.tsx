      ...
      <section className="mb-14 border-b border-[#e5e5e5] pb-12">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', margin: '60px 0' }}>
          <svg width="900" height="520" viewBox="0 0 900 520" xmlns="http://www.w3.org/2000/svg">
            <style>{`
              .box { fill: none; stroke: black; stroke-width: 1.5; }
            ...
            {/* Left Vertical Flow Boxes */}
            <rect x="100" y="20" width="320" height="60" className="box"/>
            <text x="260" y="55" textAnchor="middle" className="text">Enterprise Sustainability Data</text>

            <rect x="100" y="120" width="320" height="70" className="box"/>
            <text x="260" y="155" textAnchor="middle" className="text layer">Layer 1 — CDI</text>
            <text x="260" y="175" textAnchor="middle" className="text">Semantic Meaning</text>

            <rect x="100" y="220" width="320" height="70" className="box"/>
            <text x="260" y="255" textAnchor="middle" className="text layer">Layer 2 — CMP</text>
            <text x="260" y="275" textAnchor="middle" className="text">Framework Interpretation</text>

            <rect x="100" y="320" width="320" height="80" className="box"/>
            <text x="260" y="355" textAnchor="middle" className="text layer">Layer 3 — Jurisdiction Layer</text>
            <text x="260" y="375" textAnchor="middle" className="text">Regulatory Interpretation</text>

            {/* Vertical Arrows */}
            <line x1="260" y1="80" x2="260" y2="120" className="line"/>
            <line x1="260" y1="190" x2="260" y2="220" className="line"/>
            <line x1="260" y1="290" x2="260" y2="320" className="line"/>

            {/* Branching Line */}
            <line x1="420" y1="255" x2="560" y2="255" className="line"/>

            {/* Framework Boxes */}
            <rect x="560" y="150" width="200" height="40" className="box"/>
            <text x="660" y="175" textAnchor="middle" className="text">ESRS</text>

            <rect x="560" y="200" width="200" height="40" className="box"/>
            <text x="660" y="225" textAnchor="middle" className="text">ISSB</text>

            <rect x="560" y="250" width="200" height="40" className="box"/>
            <text x="660" y="275" textAnchor="middle" className="text">GRI</text>

            <rect x="560" y="300" width="200" height="40" className="box"/>
            <text x="660" y="325" textAnchor="middle" className="text">CDP</text>

            <rect x="560" y="350" width="200" height="40" className="box"/>
            <text x="660" y="375" textAnchor="middle" className="text">EU Taxonomy</text>

            {/* Branch Lines */}
            <line x1="560" y1="170" x2="420" y2="360" className="line"/>
            <line x1="560" y1="220" x2="420" y2="360" className="line"/>
            <line x1="560" y1="270" x2="420" y2="360" className="line"/>
            <line x1="560" y1="320" x2="420" y2="360" className="line"/>
            <line x1="560" y1="370" x2="420" y2="360" className="line"/>
          </svg>
        </div>
        <p style={{ textAlign: 'center', fontSize: '13px', marginTop: '10px' }} className="text-[#666]">
          Figure — Canonical ESG Three-Layer Modelling Architecture
        </p>
      </section>
