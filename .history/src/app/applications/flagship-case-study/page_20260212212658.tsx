...
export const metadata: Metadata = {
  title: "Flagship Case Study - Multi-Standard Reporting - Canonical ESG",
  description: "Multi-standard reporting without semantic duplication — ESRS + ISSB + GRI + CDP alignment using Canonical ESG infrastructure.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/flagship-case-study",
  },
}
...
export default function FlagshipCaseStudyPage() {
  return (
    <main className="max-w-[800px] mx-auto px-6 py-12">
      ...
      <section className="mb-14 border-b border-[#e5e5e5] pb-12">
        <h2 className="font-serif text-[#1a1a1a] text-2xl font-medium mb-6">Modelling Architecture Overview</h2>
        <div style={{ display: 'flex', justifyContent: 'center', margin: '80px 0' }}>
          <svg width="1000" height="600" viewBox="0 0 1000 600" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Left Vertical Architecture */}

            {/* Enterprise Data */}
            <rect x="120" y="40" width="360" height="60" className="box"/>
            <text x="300" y="75" textAnchor="middle" className="text">
              Enterprise Sustainability Data
            </text>

            {/* Layer 1 */}
            <rect x="120" y="140" width="360" height="80" className="box"/>
            <text x="300" y="175" textAnchor="middle" className="text layer">
              Layer 1 — CDI
            </text>
            <text x="300" y="195" textAnchor="middle" className="text small">
              Semantic Meaning (Framework-Neutral)
            </text>

            {/* Layer 2 */}
            <rect x="120" y="260" width="360" height="80" className="box"/>
            <text x="300" y="295" textAnchor="middle" className="text layer">
              Layer 2 — CMP
            </text>
            <text x="300" y="315" textAnchor="middle" className="text small">
              Framework Interpretation
            </text>

            {/* Layer 3 */}
            <rect x="120" y="380" width="360" height="90" className="box"/>
            <text x="300" y="415" textAnchor="middle" className="text layer">
              Layer 3 — Jurisdiction Layer
            </text>
            <text x="300" y="435" textAnchor="middle" className="text small">
              Regulatory & Legal Interpretation
            </text>

            {/* Vertical Flow Lines */}
            <line x1="300" y1="100" x2="300" y2="140" className="line"/>
            <line x1="300" y1="220" x2="300" y2="260" className="line"/>
            <line x1="300" y1="340" x2="300" y2="380" className="line"/>

            {/* ===== Framework Branch (From Layer 2) ===== */}

            {/* Branch Anchor */}
            <line x1="480" y1="300" x2="620" y2="300" className="line"/>

            {/* Framework Boxes */}
            <rect x="620" y="180" width="240" height="45" className="box"/>
            <text x="740" y="207" textAnchor="middle" className="text">ESRS</text>

            <rect x="620" y="230" width="240" height="45" className="box"/>
            <text x="740" y="257" textAnchor="middle" className="text">ISSB</text>

            <rect x="620" y="280" width="240" height="45" className="box"/>
            <text x="740" y="307" textAnchor="middle" className="text">GRI</text>

            <rect x="620" y="330" width="240" height="45" className="box"/>
            <text x="740" y="357" textAnchor="middle" className="text">CDP</text>

            <rect x="620" y="380" width="240" height="45" className="box"/>
            <text x="740" y="407" textAnchor="middle" className="text">SASB</text>

            {/* Lines to Frameworks */}
            <line x1="620" y1="202" x2="480" y2="300" className="line"/>
            <line x1="620" y1="252" x2="480" y2="300" className="line"/>
            <line x1="620" y1="302" x2="480" y2="300" className="line"/>
            <line x1="620" y1="352" x2="480" y2="300" className="line"/>
            <line x1="620" y1="402" x2="480" y2="300" className="line"/>

            {/* ===== Jurisdiction Branch (From Layer 3) ===== */}

            {/* Branch Anchor */}
            <line x1="480" y1="425" x2="620" y2="425" className="line"/>

            {/* Jurisdiction Boxes */}
            <rect x="620" y="450" width="240" height="45" className="box"/>
            <text x="740" y="477" textAnchor="middle" className="text">EU Taxonomy</text>

            <rect x="620" y="500" width="240" height="45" className="box"/>
            <text x="740" y="527" textAnchor="middle" className="text">CSRD</text>

            {/* Lines to Jurisdictions */}
            <line x1="620" y1="472" x2="480" y2="425" className="line"/>
            <line x1="620" y1="522" x2="480" y2="425" className="line"/>
