...
export const euTaxonomyMetadata: Metadata = {
  title: "EU Taxonomy - Canonical ESG",
  description: "EU Taxonomy reporting and compliance made easy with Canonical ESG.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/eu-taxonomy",
  },
}

export const flagshipCaseStudyMetadata: Metadata = {
