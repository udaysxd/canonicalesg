export default function RegulatoryModellingPage() {
  return (
    <main className="max-w-[800px] mx-auto px-6 py-12">
      <nav className="mb-6">
        <a href="/use-cases" className="text-[#666] hover:text-[#1a1a1a] text-sm">Use Cases</a>
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-neutral max-w-none">
          <ul className="list-disc list-inside space-y-2 text-[#333]">
            <li>
              <a href="/use-cases/cross-framework-climate-modelling" className="text-[#333] hover:text-[#111] border-b border-[#333] hover:border-[#111]">
                Cross-Framework Climate Modelling
              </a>
            </li>
            <li>
              <a href="/use-cases/consultants" className="text-[#333] hover:text-[#111] border-b border-[#333] hover:border-[#111]">
                Consultants
              </a>
            </li>
          </ul>
