...
export const crossFrameworkClimateModellingMetadata: Metadata = {
  title: "Cross-Framework Climate Modelling - Canonical ESG",
  description: "How Canonical ESG enables cross-framework climate disclosure modelling across ESRS, IFRS S2, GRI, CDP, and SASB without semantic duplication.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/cross-framework-climate-modelling",
  },
}

export const doubleMaterialityAnalysisMetadata: Metadata = {
  title: "Double Materiality Analysis - Canonical ESG",
  description: "How Canonical ESG enables structured double materiality analysis across ESRS, ISSB, and other frameworks without interpretive conflation.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/double-materiality-analysis",
  },
}

export const euTaxonomyKpiAlignmentMetadata: Metadata = {
  title: "EU Taxonomy KPI and Alignment Modelling - Canonical ESG",
  description: "How Canonical ESG enables EU Taxonomy KPI and alignment modelling across ESRS, IFRS S2, GRI, CDP, and SASB without semantic duplication.",
  alternates: {
    canonical: "https://canonicalesg.org/applications/eu-taxonomy-kpi-alignment",
  },
}
