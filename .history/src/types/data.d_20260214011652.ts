...
declare module '@/data/cmp-packs/issb/ifrs-s2.json' {
  const value: {
    id: string;
...
declare module '@/data/presentation-layer/sss-position-statement.json' {
  const value: {
    id: string;
    name: string;
    purpose: string;
...
declare module '@/data/presentation-layer/sss-transition-annex.json' {
  const value: {
    id: string;
    name: string;
    purpose: string;
...
declare module '@/data/cdi-intents.json' {
  const value: {
    id: string;
    name: string;
    version: string;
    ...
    intents: Array<{
      ...
      calculationRole: "measured" | "derived" | "declarative";
